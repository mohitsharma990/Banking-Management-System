...
int main()
{
    FILE *f1 = fopen(CUSPATH, "rb+");    // rb+ opens a binary file for both reading and writing, allowing modifications.
    FILE *f2 = fopen(EMPPATH, "rb+");
    FILE *f3 = fopen(LOANPATH, "rb+");
    FILE *f4 = fopen(COUNTERPATH, "rb");
    FILE *f5 = fopen(HISTORYPATH, "rb");    //rb opens a binary file for reading only; writing is not allowed.
    ...
    printf("================ Customer ==================\n");
    rewind(f1);  //resets the file pointer of f1 to the beginning of the file.
